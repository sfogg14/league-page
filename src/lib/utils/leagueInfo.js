...
export const homepageText = `
  <p>This is baby's first website since high school. This is for a fantasy football league. All members are on a scale of degeneracy that registers as "significant" to our partners and peers.</p>
  <p>"Deebo is a delicate flower." - Alpacalypse</p>
  <p>"Them sauces are so dank." - Chauncey</p>
  <p></p>
  <p></p>
`;
...
export const managers = [
    {
      ...
      "photo": "/managers/DSC_0984.nef", // square ratio recommended (no larger than 500x500)
      ...
      "rival": {
        name: "Your Mum", // Can be anything (usually your rival's name)
